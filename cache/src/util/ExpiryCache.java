...
/**
 * Created by hiteshgupta on n adding   2/14/16.
 */
public interface ExpiryCache <K,V> {
     ...
     * @param timeUnit ­ a TimeUnit (ref: java.util.concurrent.TimeUnit) determining how to interpret the timeout
    parameter
     */

    public void put(K key,V value,int ttl, TimeUnit timeUnit);
    /**
     * get entry.value from cache for this key unless that is expired. * @param key
